...
if (isset($_GET["do"])) {
    if ($_GET["do"] == "edit") {
        $title = $lang["page_game_title_edit"];
    } else if ($_GET["do"] == "new") {
        $title = $lang["page_game_title_submit"];
    }
}
?>
<div class="header">
   ...
   <div class="row">
	   <div class="col-md-8">	
			<div class="product">
				...
				if (isset($_GET["do"])) {
					if ($_GET["do"] == "edit") {
						require 'templates/'.$get->system("template").'/parts/edit_game.php';
					} else if ($_GET["do"] == "new") {
						require 'templates/'.$get->system("template").'/parts/add_game.php';
					}
				}
				?>
