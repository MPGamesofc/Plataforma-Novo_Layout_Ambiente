...
if (isset($_POST['page'])) {
    ...
    $queryNum = $db->query("SELECT COUNT(*) as gameNum FROM games ");
    $resultNum = $queryNum->fetch_assoc();
    $rowCount = $resultNum['gameNum'];
    $config = array('baseURL' => $get->system("site_url") . '/templates/'.$get->system("template").'/ajax/profile_games.php?id=' . $id . '&limit=' . $limit, 'totalRows' => $rowCount, 'currentPage' => $start, 'perPage' => $limit, 'contentDiv' => 'game-list');
